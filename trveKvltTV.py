from youtube_archivist import StreamArchive
from youtube_archivist.log import LOG
...
urls = [
    ...
    "https://www.youtube.com/user/NihiLizTikVoiD/videos",
    "https://www.youtube.com/user/Adnan3098/videos",
...
for url in urls:
    ...
    tv = StreamArchive(url, name="TrveKvlt")
    #tv.bootstrap()
    #tv.populate_info()
    tv.remove_dead()
